...
/**
 * <code>Allocator</code> is a utility class to allocate memory using direct or
 * heap {@link Buffer}. It also handles deallocation of native memory buffers
 * when no longer used.
 * 
...
public final class Allocator {
     ...
     */
    protected static final Logger logger = FactoryLogger.getLogger("sethlans-core.alloc");
    /**
