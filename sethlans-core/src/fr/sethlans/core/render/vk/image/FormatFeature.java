...
public enum FormatFeature implements VkFlag<FormatFeature> {
    ...
    SAMPLED_IMAGE_FILTER_MINMAX(VK12.VK_FORMAT_FEATURE_SAMPLED_IMAGE_FILTER_MINMAX_BIT);

    private final int bits;

    private FormatFeature(int bits) {
        this.bits = bits;
    }
